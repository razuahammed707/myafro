  ...
  return (
    <SafeAreaView style={tw`px-5 relative h-full`}>
      <View style={tw`flex flex-row items-center justify-between`}>
        <Text style={tw`font-bold text-lg text-center`}>{item.title}</Text>
        <Icon name="cross" type="entypo" size={24} color="black" />
      </View>
      ...
      {item.image !== "" ? (
        <View>
          ...
          <View>
            <View style={tw`flex flex-row mt-5`}>
              ...
              <Text style={tw`text-base ml-2 w-80`}>{item.rule1}</Text>
            </View>
            <View style={tw`flex flex-row mt-5`}>
              <Icon name="shield" type="feather" size={20} color="black" />
              <Text style={tw`text-base ml-2 w-80`}>{item.rule2}</Text>
            </View>
            <View style={tw`flex flex-row mt-5`}>
              <Icon name="battery" type="feather" size={28} color="black" />
              <Text style={tw`text-base ml-2 w-80`}>{item.rule3}</Text>
            </View>
          </View>
        </View>
      ) : (
        <View style={tw`mt-10`}>
          <View style={tw`flex flex-row items-center justify-between mt-5`}>
            <Text style={tw`text-base`}>{item.item1}</Text>
            <View style={tw`flex flex-row justify-between items-center`}>
              <Text style={tw`text-base mr-2 text-gray-400`}>
                {item.item1_val}
              </Text>
              <Icon
          ...
          <View style={tw`flex flex-row items-center justify-between mt-5`}>
            <Text style={tw`text-base`}>{item.item2}</Text>
            <View style={tw`flex flex-row justify-between items-center`}>
              <Text style={tw`text-base mr-2 text-gray-400`}>
                {item.item2_val}
              </Text>
          ...
          <View style={tw`flex flex-row items-center justify-between mt-5`}>
            <Text style={tw`text-base`}>{item.item3}</Text>
            <View style={tw`flex flex-row justify-between items-center`}>
              <Text style={tw`text-base mr-2 text-gray-400`}>
                {item.item3_val}
              </Text>
          ...
          <View style={tw`flex flex-row items-center justify-between mt-5`}>
            <Text style={tw`text-base`}>{item.item4}</Text>
            <View style={tw`flex flex-row justify-between items-center`}>
              <Text style={tw`text-base mr-2 text-gray-400`}>
                {item.item4_val}
              </Text>
          ...
          <View style={tw`flex flex-row items-center justify-between mt-5`}>
            <Text style={tw`text-base`}>{item.item5}</Text>
            <View style={tw`flex flex-row justify-between items-center`}>
              <Text style={tw`text-base mr-2 text-gray-400`}>
                {item.item5_val}
              </Text>
      ...
      {item.image === "" && (
        <View style={tw`absolute bottom-30 w-full left-5`}>
