  ...
  return (
    <SafeAreaView>
      ...
      >
        ...
        <View>
          <Text style={tw`text-xl`}>Help</Text>
        </View>
      </View>
      {/* Top section end */}
      ...
      <View style={tw`flex flex-row items-center p-5`}>
        ...
        <View style={tw`ml-4`}>
          ...
          <View style={tw`flex flex-row items-center`}>
            <Text style={tw`text-xl`}>DR86548</Text>
          </View>
        </View>
      </View>
      ...
      <View style={tw`flex flex-row items-center justify-between px-5`}>
        <View>
          <Text style={tw`text-lg text-gray-400`}>Start</Text>
          <Text style={tw`text-lg`}>23. des kl. 18:00</Text>
        </View>
        <View>
          <Text style={tw`text-lg text-gray-400`}>Slutt</Text>
          <Text style={tw`text-lg`}>3. des kl. 23:00</Text>
        </View>
      ...
      <View style={tw`px-5 mt-5`}>
        <View style={tw`flex flex-row mt-5`}>
          <Icon
            ...
            color="#ffc727"
          />
          <Text style={tw`text-xl ml-2`}>Saloon location</Text>
        </View>
        <View style={tw`my-5`}>
          <Text style={tw`text-lg text-gray-600 ml-1`}>
        ...
        <View style={tw`mt-10`}>
        <Text style={tw`font-bold text-xl mr-2`}>Saloon location</Text>
          <View
            style={{
          ...
          >
            <View style={tw`flex flex-row justify-between items-center mt-5`}>
              <Text style={tw`text-xl font-normal`}>Home Saloon</Text>
              <Text style={tw`text-base text-gray-400`}>kr6355</Text>
            </View>
            <View style={tw`flex flex-row justify-between items-center mt-5`}>
              <Text style={tw`text-xl`}>Home Saloon</Text>
              <Text style={tw`text-base text-gray-400`}>kr4915</Text>
            </View>
            <View style={tw`flex flex-row justify-between items-center mt-5`}>
              <Text style={tw`text-xl`}>Home Saloon</Text>
            ...
            <View style={tw`flex flex-row justify-between items-center mt-5`}>
              <Text style={tw`text-xl`}>Home Saloon</Text>
              <View style={tw`flex flex-row items-center`}>
              <Text style={tw`text-xl mr-2`}>kr1440</Text>
              <Icon name="alert-circle" type="feather" size={20} color="#000" />
              </View>
            </View>
          </View>
